...
let editTask = (taskName) => {
    ...
    // creating the input for editing the task
    let taskContainer = document.querySelector(`#t${task.id}`);
    taskContainer.innerHTML = ` <input type="text" name="" id="editInput" class="form-control">
`;
